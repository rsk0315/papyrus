...
class HyperParser:
    ...
    def is_in_code(self):
        ...
        i = self.bracketing[self.indexbracket][0]
        return (not self.isopener[self.indexbracket] or
                self.rawtext[self.bracketing[self.indexbracket][0]]
##                not in ('#', '"', "'"))
##                not in ('#', '"', "'", '/'))
                not in ('#', '"', "'") or
                self.rawtext[i:i+2] not in ('//', '/*'))
...
##                      rawtext[bracketing[brck_index-1][0]] in '#/'):
                        (rawtext[bracketing[brck_index-1][0]] == '#' or
                         rawtext[i:i+2] in ('//', '/*'))):
                    # Eat a comment
                    brck_index -= 2
                    brck_limit = bracketing[brck_index][0]
