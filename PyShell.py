...
class ModifiedColorDelegator(ColorDelegator):
    ...
    def __init__(self, ext):
        self.ext = ext if ext else '.py'
        ColorDelegator.__init__(self, ext)
        self.LoadTagDefs()
...
##        self.ftype = StringVar(value='Python')
...
##        sys.__stdout__.write(repr(self.shell)+'\n')
##        if sys.stdout != sys.__stdout__:
##            sys.stdout.write(repr(self.shell)+'\n')

##        self.fileno_ = fileno_
##        sys.stdout.write(repr(shell)+'\n')
...
class PseudoInputFile(PseudoFile):
    ...
    def __init__(self, shell, tags, encoding=None):
        PseudoFile.__init__(self, shell, tags, encoding=None)
        self._line_buffer = ''
...
def main():
    ...
    startup = False
    try:
        opts, args = getopt.getopt(sys.argv[1:], "c:deEihnr:st:")
    ...
    if system() == 'Windows':
        ...
        iconfile = os.path.join(icondir, 'xidle.ico')
